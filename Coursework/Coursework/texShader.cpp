...
texShader::texShader(ID3D11Device* device, HWND hwnd) : BaseShader(device, hwnd)
{
	initShader(L"texShaderVS.cso", L"texShaderPS.cso");
}
...
void texShader::initShader(const wchar_t* vsFilename, const wchar_t* psFilename)
{
